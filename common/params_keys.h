...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DisableDriverMonitoring", {PERSISTENT, BOOL, "0", "0", 0, SETTINGS_SIMPLE}},
    ...
    {"LaneCenteringIntegralGain", {PERSISTENT, FLOAT, "0.03", "0.0", 3}},
    ...
    {"TransitLkaContinuation", {PERSISTENT, BOOL, "0", "0", 2, SETTINGS_SIMPLE}},
    {"TransitLkaIntervention", {PERSISTENT, INT, "0", "0", 2, SETTINGS_SIMPLE}},
    {"TransitLkaRamp", {PERSISTENT, INT, "0", "0", 2, SETTINGS_SIMPLE}},
